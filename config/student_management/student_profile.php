...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .profile-title { color: white; font-size: 28px; font-weight: 600; margin-bottom: 8px; z-index:1; position: relative; }
        ...
        .info-item { position: relative; animation: slideInLeft 0.5s ease-out; animation-fill-mode: both; }
        ...
        .info-label {
            display: flex; align-items: center; font-size: 14px; font-weight: 600; color: #374151;
        ...
        .action-buttons { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin-top: 40px; }
        .btn {
            display: flex; align-items: center; justify-content: center;
    ...
    <div class="profile-container">
        ...
        <div class="profile-body">
            <div class="info-grid">
                ...
                <div class="info-item">
                    <div class="info-label"><i class="fas fa-graduation-cap"></i>Grade Level</div>
                    <div class="info-value">Grade <?php echo htmlspecialchars($user['grade']); ?></div>
                </div>
            </div>

            <div class="action-buttons">
                <a href="../student_management/student_subject.php" class="btn btn-primary">
                    <i class="fas fa-book-open"></i>Enroll in Courses
                </a>
                
                <a href="../student_management/edit_student.php" class="btn btn-edit">
    ...
    <script>
        function uploadAvatar(input) {
            if (input.files && input.files[0]) {
                ...
                .then(data => {
                    if (data.success) {
                        avatar.innerHTML = `
                            <img src="../uploads/${data.filename}" alt="Profile Picture">
        ...
        function showMessage(message, type) {
            ...
            messageDiv.style.cssText = `
                ...
                font-weight: 600; z-index: 1000; animation: slideIn 0.3s ease-out;
