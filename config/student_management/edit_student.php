...
// Make sure only students can access
...
if (isset($_POST['update'])) {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            ...
            $checkColumns = $conn->query("SHOW COLUMNS FROM students");
            $columns = [];
            ...
            $updateFields = ['name=?', 'age=?', 'grade=?', 'email=?'];
            $updateTypes = 'siss';
            $updateValues = [$name, $age, $grade, $email];
            ...
            $updateQuery = "UPDATE students SET " . implode(', ', $updateFields) . " WHERE id=?";
...
<body>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="age" name="age" class="form-input" 
                               value="<?php echo $row['age']; ?>" required min="16" max="25">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="grade">
                            <i class="fas fa-graduation-cap"></i> Grade/Class <span class="required">*</span>
                        </label>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Age validation
            if (age < 16 || age > 25) {
                showMessage('Please enter a valid age between 16 and 25.', 'error');
                return false;
            }
